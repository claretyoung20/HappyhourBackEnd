...
export class ProductImageComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.productImageService
            ...
            .subscribe(
                (res: HttpResponse<IProductImage[]>) => this.paginateProductImages(res.body, res.headers),
    ...
    trackId(index: number, item: IProductImage) {
        return item.id;
    }
    ...
    private paginateProductImages(data: IProductImage[], headers: HttpHeaders) {
