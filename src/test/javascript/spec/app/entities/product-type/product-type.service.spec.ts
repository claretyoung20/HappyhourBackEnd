    ...
    describe('ProductType Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/product-types';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a ProductType', () => {
                service.create(new ProductType(null)).subscribe(received => {
            ...
            it('should update a ProductType', () => {
                service.update(new ProductType(123)).subscribe(received => {
            ...
            it('should return a ProductType', () => {
