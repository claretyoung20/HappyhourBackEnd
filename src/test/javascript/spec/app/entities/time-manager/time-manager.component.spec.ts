...
import { TimeManagerComponent } from 'app/entities/time-manager/time-manager.component';
...
describe('Component Tests', () => {
    describe('TimeManager Management Component', () => {
        let comp: TimeManagerComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TimeManagerComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.timeManagers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
