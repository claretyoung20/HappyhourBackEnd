...
import { TableTypeComponent } from 'app/entities/table-type/table-type.component';
...
describe('Component Tests', () => {
    describe('TableType Management Component', () => {
        let comp: TableTypeComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TableTypeComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.tableTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
