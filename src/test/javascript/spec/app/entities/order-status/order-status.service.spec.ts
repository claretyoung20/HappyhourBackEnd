    ...
    describe('OrderStatus Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/order-statuses';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a OrderStatus', () => {
                service.create(new OrderStatus(null)).subscribe(received => {
            ...
            it('should update a OrderStatus', () => {
                service.update(new OrderStatus(123)).subscribe(received => {
            ...
            it('should return a OrderStatus', () => {
