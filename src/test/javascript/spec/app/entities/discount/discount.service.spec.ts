    ...
    describe('Discount Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/discounts';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Discount', () => {
                service.create(new Discount(null)).subscribe(received => {
            ...
            it('should update a Discount', () => {
                service.update(new Discount(123)).subscribe(received => {
