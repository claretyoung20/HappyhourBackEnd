...
import { BookTableComponent } from 'app/entities/book-table/book-table.component';
...
describe('Component Tests', () => {
    describe('BookTable Management Component', () => {
        let comp: BookTableComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(BookTableComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.bookTables[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
