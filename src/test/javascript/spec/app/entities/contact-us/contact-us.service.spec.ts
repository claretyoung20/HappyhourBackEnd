    ...
    describe('ContactUs Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/contactuses';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a ContactUs', () => {
                service.create(new ContactUs(null)).subscribe(received => {
            ...
            it('should update a ContactUs', () => {
                service.update(new ContactUs(123)).subscribe(received => {
