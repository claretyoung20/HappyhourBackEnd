...
import com.happyhour.myapp.repository.RatingRepository;
import com.happyhour.myapp.service.RatingService;
import com.happyhour.myapp.service.dto.RatingDTO;
import com.happyhour.myapp.service.mapper.RatingMapper;
...
public class RatingResourceIntTest {
    ...
    public void createRating() throws Exception {
        ...
        assertThat(testRating.getDateCreated()).isEqualTo(DEFAULT_DATE_CREATED);
        assertThat(testRating.getDateUpdated()).isEqualTo(DEFAULT_DATE_UPDATED);
    ...
    public void updateRating() throws Exception {
        ...
        assertThat(testRating.getDateCreated()).isEqualTo(UPDATED_DATE_CREATED);
        assertThat(testRating.getDateUpdated()).isEqualTo(UPDATED_DATE_UPDATED);
